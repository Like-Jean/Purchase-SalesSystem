	...
	private void initialize() {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				goods good  = new goods();
				good.setGoods_category(textPane.getText().trim().toString());
				good.setGoods_cost(Float.parseFloat(textPane_6.getText().trim().toString()));
				good.setGoods_down(Integer.parseInt(textPane_5.getText().trim().toString()));
				good.setGoods_factory(textPane_8.getText().trim().toString());
				good.setGoods_id((String)comboBox_2.getSelectedItem());
				good.setGoods_name(textPane_2.getText().trim().toString());
				good.setGoods_prprice(Float.parseFloat(textPane_7.getText().trim().toString()));
				good.setGoods_up(Integer.parseInt(textPane_4.getText().trim().toString()));
				good.setGoods_version(textPane_9.getText().trim().toString());
		...
		button.setBounds(149, 213, 93, 23);
